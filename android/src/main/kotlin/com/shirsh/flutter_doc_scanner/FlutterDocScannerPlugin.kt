...
class FlutterDocScannerPlugin : MethodCallHandler, ActivityResultListener,
    ...
    // Update locale based on the passed language code.
    private fun updateLocale(localeString: String) {
        try {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        // Read locale parameter (default is "en")
        val arguments = call.arguments as? Map<*, *>
        val locale = (arguments?.get("locale") as? String) ?: "en"
        updateLocale(locale)
